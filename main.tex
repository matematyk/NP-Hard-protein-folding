...
badaczy bardzo pożądaną informacją min. w przypadku projektowania leków.
...
\ldots,k\} \rightarrow L$ takie, że sąsiednie liczby odpowiadają sąsiednim
punktom z kraty, tzn.
\begin{equation*}
		 \omega(i) \neq \omega(j)
...
zagięcie można odnaleźć, obliczając energię każdego możliwego zagięcia. W praktyce długości sekwencji wahają się pomiędzy $50$ do ponad $1500$ aminokwasów. 
